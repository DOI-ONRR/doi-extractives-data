...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Employment</td>
      <td>The Bureau of Labor Statistics (BLS) publishes the Alaska North Slope Borough annual average employment for oil and gas extraction (<span class="term term-p" data-term="north american industry classification system (naics)" title="Click to define" tabindex="0">NAICS<icon class="icon-book"></icon></span> Code 211).</td>
