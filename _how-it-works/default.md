...
<section accordion class="container-outer">
	...
	<section class="container">
		<h3 name="natural-resources" class="landing-section_category">Natural resources</h3>
		<div class="container landing-section_open overview">
			<h5 name="process-overview" class="landing-heading"><a href="{{site.baseurl}}/how-it-works/process-overview/">Overview</a></h5>
    ...
    <div class="container landing-section" accordion-item accordion-open="true">
		...
		<div class="container landing-section" accordion-item accordion-open="true">
			<h5 name="state-laws-and-regulations" class="landing-heading"><a href="{{site.baseurl}}/how-it-works/state-laws-and-regulations/">State laws and regulations</a></h5>
			<button class="accordion-button" accordion-button></button>
			<div class="accordion-content">
