...
## ONRR.gov discovery
Shortly before I started my internship, the team [took on responsibility for a second site ONRR.gov,]( https://revenuedata.doi.gov/blog/adding-a-product/),  and my biggest project was to start discovery work to understand the needs of users of that site. I also did some design concepting that was part of a project I needed to do for a graduate school course.
