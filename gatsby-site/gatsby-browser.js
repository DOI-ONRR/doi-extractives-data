...
exports.onClientEntry = () => {
  ...
  if(path.includes("/explore") && (path.endsWith("e/") || path.endsWith("e"))) {
    ...
    if(path.includes("/native-american-ownership-governance") && !lastFourteen.includes("default-page")){
      ...
      loader.addPagesArray([,{"componentChunkName":"component---src-templates-default-js","layout":"layout---index","layoutComponentChunkName":"component---src-layouts-index-js","jsonName":"how-it-works-aml-reclamation-program.json","path":path}]);
    }
