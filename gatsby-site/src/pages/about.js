...
const AboutPage = () => {
  let baseUrl = (typeof location !== 'undefined' && location) ? location.origin : "";
              ...
              <div>
                <h2 className="ribbon-card-top-text-header">Understand natural resource management on federal land:</h2>
                  <ul className="list-bullet ribbon-card-top-list">
                    <li><a href={baseUrl+"/how-it-works/ownership/"}>Land ownership</a></li>
                    <li><a href={baseUrl+"/how-it-works/#laws"}>Laws and regulations</a></li>
                    <li><a href={baseUrl+"/how-it-works/#process"}>Oil, gas, minerals, and renewable energy</a></li>
                    <li><a href={baseUrl+"/how-it-works/audits-and-assurances/"}>Audits and assurances</a></li>
                  </ul>
                  <a href={baseUrl+"/how-it-works/"} className="button-primary">How it works</a>
              </div>
            </div>
          </div>
        </div>
