...
>>>>>>> got rid of rounding issue
	          ...
	          function createDomains (interval, domain) {
	            ...
	            interval.forEach(function (step, i) {
	              if (i === 0) {
	                ...
	                domainStart.push(interval[i - 1] * domain[1]);
	              }
	              domainEnd.push(step * domain[1]);
	            });
	          ...
	          String.prototype.has = function (units) {
	            return this.indexOf(units) > 1;
	          }

	          function getUnique(data, _steps, domain) {
	          ...
	          var _steps = d3.range(1, +steps + 1);
	          var intervals = _steps.map(function(key) {
	            return key / _steps.length;
	          });
	          ...
	          format.end = function(value, units) {
	            ...
	            } else if (units.has('kilowatt')) {
	              return [format.si(value), 'kWh'].join(' ');
	            } else if(units.has('thousands of pounds')) {
	              return [format.si(value), 'thousands of pounds'].join(' ');
	            } else if(units.has('millions of btus')) {
