    ...
    <article class="container-left bureaus">
      ...
      <article class="bureau">
        <div class="bureau-left">
          <img class="bureau-image" src="{{ site.baseurl }}/img/logos/BIA-mark.png" alt="U.S. Department of the Interior Bureau of Indian Affairs 1824 Seal">
        </div>
      ...
      <article class="bureau">
        <div class="bureau-left">
          <img class="bureau-image" src="{{ site.baseurl }}/img/logos/USBR-mark.png" alt="U.S. Department of the Interior Bureau of Reclamation Seal">
        </div>
        <div class="bureau-right">
      ...
      <article class="bureau">
        <div class="bureau-left">
          <img class="bureau-image" src="{{ site.baseurl }}/img/logos/NPS-mark.png" alt="National Park Service Seal">
        </div>
        <div class="bureau-right">
      ...
      <article class="bureau">
        <div class="bureau-left">
          <img class="bureau-image" src="{{ site.baseurl }}/img/logos/USFWS-mark.png" alt="U.S. Fish and Wildlife Service Department of the Interior Seal">
        </div>
        <div class="bureau-right">
      ...
      <article class="bureau">
        <div class="bureau-left">
          <img class="bureau-image" src="{{ site.baseurl }}/img/logos/USGS-mark.png" alt="USGS Science for a changing world Seal">
        </div>
        <div class="bureau-right">
