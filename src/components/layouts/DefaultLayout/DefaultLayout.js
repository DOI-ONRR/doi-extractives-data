      ...
      <Fragment>
          ...
          meta={[
            {
              ...
              content: 'OxyG3U-Vtui-uK6wHUeOw83OgdfcfxvsWWZcb5x7aZ0'
            },
        ...
        >
          ...
          <link
            rel="icon"
            type="image/x-icon"
            href={withPrefixSVG('/img/favicon.ico')}
          />
          <link
            rel="icon"
            type="image/x-icon"
            href={withPrefixSVG('/img/favicon-16x16.png')}
            sizes="16x16"
          />
          <link
            rel="icon"
            type="image/x-icon"
            href={withPrefixSVG('/img/favicon-32x32.png')}
            sizes="32x32"
          />
        ...
        <a href="#main-content" className={classes.skipNav}>
