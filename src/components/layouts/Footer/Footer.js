    ...
    <footer className="footer">
      <Container maxWidth="lg">
        <Grid container spacing={2}>
          ...
          is powered by <Link to="/downloads" className="link-active-beta">open data</Link> and <a className="link-active-beta" href="https://github.com/ONRR/doi-extractives-data/">source code</a>.<br />
